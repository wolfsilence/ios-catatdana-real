...
struct CDEMICalculatorView: View {
    ...
    private var inputCard: some View {
        VStack(spacing: 16) {
            inputField(Strings.EMI.loanLabel, text: $vm.loanAmount, placeholder: Strings.EMI.loanPlaceholder, prefix: "Rp", keyboard: .numberPad)
            inputField(Strings.EMI.tenorLabel, text: $vm.months, placeholder: Strings.EMI.tenorPlaceholder, suffix: Strings.EMI.tenorSuffix, keyboard: .numberPad)
    ...
    private var resultCard: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack(spacing: 12) {
                miniStat(Strings.EMI.totalPayment, formatIDR(vm.totalPayment))
                miniStat(Strings.EMI.totalInterest, formatIDR(vm.totalInterest))
            }
        }
        .padding(20)
        .background(
