...
struct CDFirstProtocolView: View {
    private let url = URL(string: Constants.privacyPolicyURL)!
    ...
    var body: some View {
        ZStack {
            ...
            LinearGradient(
                stops: [
                    ...
                    .init(color: Colors.launchBackground, location: 0.5),
            ...
            VStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 5) {
                    ...
                    Text(AllStr.privacyDescription)
                        .font(.system(size: 16))
                        .foregroundColor(.white)
                }
        ...
        .toast(isPresented: $showToast,
               message: AllStr.privacyToastWait)
    }
}
