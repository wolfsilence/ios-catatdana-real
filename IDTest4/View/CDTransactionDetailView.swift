...
struct CDTransactionDetailView: View {
    ...
    init(transaction: Transaction, onBack: @escaping () -> Void) {
            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(spacing: 20) {
                        amountSection
                        infoCards
                        if !transaction.photoPath.isEmpty {
                            photoSection
                        }
                    }
                    .padding(20)
    ...
    private var pageHeader: some View {
        HStack(spacing: 12) {
            ...
            Text(Strings.TransactionDetail.title)
    ...
    private var amountSection: some View {
        VStack(spacing: 12) {
            // Type badge
            Text(transaction.type == .income ? Strings.Common.income : Strings.Common.expense)
            ...
            Text(transaction.type == .income
                ...
                .foregroundColor(transaction.type == .income ? Colors.primary : .red)
        }
    ...
    private var infoCards: some View {
        VStack(spacing: 12) {
            ...
            infoRow(
                ...
                title: Strings.TransactionDetail.category,
            ...
            infoRow(
                icon: "calendar",
                title: Strings.TransactionDetail.date,
            ...
            if !transaction.location.isEmpty {
                ...
                infoRow(
                    icon: "location.fill",
                    title: Strings.TransactionDetail.location,
            ...
            if !transaction.note.isEmpty {
                ...
                infoRow(
                    icon: "doc.text.fill",
                    title: Strings.TransactionDetail.note,
    ...
    private var photoSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            Text(Strings.TransactionDetail.photo)
                .font(.system(size: 13))
    ...
    private func loadCachedImage() async {
        guard !transaction.photoPath.isEmpty,
              let url = URL(string: transaction.photoPath) else { return }
    ...
    private func submitBizAndReload() async {
        ...
        // 从本地重新捞取最新数据
        let all = DatabaseManager.shared.loadTransactions()
