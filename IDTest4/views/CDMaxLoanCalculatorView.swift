...
struct CDMaxLoanCalculatorView: View {
    ...
    private var inputCard: some View {
        VStack(spacing: 16) {
            inputField(AllStr.mlPl, text: $vm.monthlyPayment, placeholder: AllStr.mlPp, prefix: "Rp", keyboard: .numberPad)
            inputField(AllStr.mlRl, text: $vm.annualRate, placeholder: AllStr.mlRp, suffix: AllStr.mlRsu, keyboard: .decimalPad)
            inputField(AllStr.mlTl, text: $vm.months, placeholder: AllStr.mlTp, suffix: AllStr.mlTs, keyboard: .numberPad)
