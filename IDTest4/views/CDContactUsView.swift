...
struct CDContactUsView: View {
    ...
    var body: some View {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        TextField(AllStr.cnCp, text: $contactInfo)
                    ...
                    Button {
                        ...
                        HStack(spacing: 8) {
                            ...
                            Text(isSubmitting ? AllStr.cnSg : AllStr.cnSu)
        ...
        .confirmationDialog(AllStr.cnAs, isPresented: $showImageSheet) {
        ...
        .confirmationDialog(AllStr.cnVs, isPresented: $showVideoSheet) {
            Button(AllStr.cnRv) { showVideoCamera = true }
            Button(AllStr.cnPv) { showVideoGallery = true }
            Button(AllStr.cmC, role: .cancel) { }
        }
    ...
    private func submitCdk() async {
        ...
        let req = Entity20(pclb: "contact", qkipkeyov: data)
